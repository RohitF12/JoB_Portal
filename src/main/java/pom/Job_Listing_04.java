...
public WebDriver driver;
	...
	@FindBy(xpath = "//button[contains(@class, 'MuiButton-colorPrimary css-15h2gu6')]") WebElement  Confirm_Delete_Button;
	...
	@FindBy(xpath = "//p[text()='Automation Engineer']") WebElement  Deleted_Job;
